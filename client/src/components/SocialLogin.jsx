...
const SocialLogin = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // 2. Sync with MongoDB
      // (The AuthContext onAuthStateChanged listener will also handle setting the token)
  ...
  return (
    <div className="space-y-4 w-full">
      ...
      <button
        ...
        className="w-full flex items-center justify-center space-x-3 px-4 py-3 border border-gray-200 rounded-2xl bg-white hover:bg-gray-50 hover:border-gray-300 hover:shadow-sm transition-all duration-300 group"
      >
